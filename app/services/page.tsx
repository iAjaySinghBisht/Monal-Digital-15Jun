              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <span className="grid place-items-center w-14 h-14 rounded-2xl font-display text-xl text-ink bg-teal-soft shrink-0 transition-colors duration-300 group-hover:bg-accent group-hover:text-white">
                      {s.number}
                    </span>
                  ...
                  <div className="mt-8 md:min-h-28">
                    ...
                    <p className="mt-2 text-accent-ink font-medium">{s.tagline}</p>
                  </div>
